...
namespace Encryption_Decryption_Demo
{
	class MainClass
	{
		public static void Main (string[] args)
		{
			...
			//write to a file
			System.IO.File.WriteAllText(@"/Users/Macmini10/Desktop/Encryption.txt", encryptedData);


			//Read the file
			valueFromFile = System.IO.File.ReadAllText(@"/Users/Macmini10/Desktop/Encryption.txt");
